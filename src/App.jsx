...
const App = () => {
  return (
    <div className="overflow-x-hidden overflow-y-auto min-h-screen text-neutral-400 antialiased selection:bg-cyan-300 selection:text-cyan-900">
      {/* Fixed Background (unchanged color) */}
      <div className="fixed top-0 left-0 z-[-2] w-full h-screen bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(24,24,40),rgba(255,255,255,0))]"></div>
