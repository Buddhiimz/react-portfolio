...
const TechnologyCard = ({ icon: Icon, title, subtitle, color }) => (
  <div
    className="bg-neutral-900 rounded-xl p-4 flex items-center gap-3 hover:bg-neutral-800 transition-colors duration-300"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-24 h-1 bg-gradient-to-r from-cyan-400 to-teal-400 mx-auto rounded-full mt-2.5 mb-8"></div>
      </motion.div>

      <div className="font-[Poppins] text-netraul-600 mb-10">
        <p className="text-center max-w-2xl mx-auto">
          Discover the powerful Tools and Technologies I used to create
          high-performing websites & mobile Applications.
        </p>
      </div>
