      ...
      <div className="flex flex-wrap mt-6">
        ...
        >
          <div className="relative w-[300px] h-[400px] sm:w-[400px] sm:h-[500px]">
            <div
              className="border-segment-container"
              style={{
                position: "absolute",
                top: "-20px",
                left: "-20px",
            ...
            >
              <div
                className="corner-piece top-left"
                style={{
                  position: "absolute",
                  top: "0",
                  left: "0",
              ...
              <div
                className="corner-piece top-right"
                style={{
                  position: "absolute",
                  top: "0",
                  right: "0",
              ...
              <div
                className="corner-piece bottom-left"
                style={{
                  position: "absolute",
                  bottom: "0",
                  left: "0",
              ...
              <div
                className="corner-piece bottom-right"
                style={{
                  position: "absolute",
                  bottom: "0",
                  right: "0",
              ...
              <div
                className="border-segment top-segment"
                style={{
                  position: "absolute",
                  top: "0",
                  left: "40px",
              ...
              <div
                className="border-segment right-segment"
                style={{
                  position: "absolute",
                  top: "40px",
                  right: "0",
              ...
              <div
                className="border-segment bottom-segment"
                style={{
                  position: "absolute",
                  bottom: "0",
                  right: "40px",
              ...
              <div
                className="border-segment left-segment"
                style={{
                  position: "absolute",
                  bottom: "40px",
                  left: "0",
        ...
        >
          <p
            className="text-left text-sm lg:text-base lg:w-11/12 p-4 lg:p-5 leading-relaxed"
            style={{ fontFamily: "'Poppins', sans-serif" }}
          >
            I am Buddhima Vilochana, a Software Engineering undergraduate at
